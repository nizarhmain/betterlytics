! function() {
    ...
    function S() {
        "visible" === r.visibilityState && r.hasFocus() && null === h ? h = Date.now() : "hidden" !== r.visibilityState && r.hasFocus() || (p = e(), h = null, m())
    }

    function n(t, e) {
        var n = "pageview" === t;
        if (n && v && (m(), b = f(), y = g()), /^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(o.hostname) || "file:" === o.protocol) return c(t, "localhost", e);
        ...
        var i = {};
        i.n = t, i.v = 5, i.u = o.href, i.d = s, i.r = r.referrer || null, e && e.meta && (i.m = JSON.stringify(e.meta)), e && e.props && (i.p = e.props), e && !1 === e.interactive && (i.i = !1), n && (a = !1, d = i.u, u = i.p, w = -1, p = 0, h = Date.now(), v || (r.addEventListener("visibilitychange", S), window.addEventListener("blur", S), window.addEventListener("focus", S), v = !0)), E(l, i, e)
    }
    ...
    }, window.addEventListener("popstate", k)), "hidden" === r.visibilityState || "prerender" === r.visibilityState ? r.addEventListener("visibilitychange", function() {
