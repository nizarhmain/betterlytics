...
export function IntegrationSheet({ open, onOpenChange, siteId }: IntegrationSheetProps) {
  ...
  const trackingScript = `<script async src="https://analytics.example.com/tracker.js" data-site-id="${siteId}"></script>`;
        ...
        <div className='flex h-full flex-col'>
          <SheetHeader className='border-border space-y-1.5 border-b p-6'>
            <div className='flex items-center justify-between'>
              ...
              <div className='flex items-center'>
                ...
                integrationStatus.scriptInstalled &&
          ...
          <div className='flex-grow space-y-6 overflow-y-auto p-6'>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              <Card className='bg-card border-border'>
                <CardHeader>
                  <CardTitle className='text-card-foreground text-base font-medium'>Integration Status</CardTitle>
                  <CardDescription className='text-muted-foreground text-sm'>Track your progress</CardDescription>
                </CardHeader>
                <CardContent className='space-y-3'>
                  ...
                  <StatusItem
                    ...
                    isComplete={integrationStatus.scriptInstalled}
                  />
                  <StatusItem
          ...
          <div className='border-border bg-background sticky mt-auto flex justify-end border-t p-6'>
            <Button variant='outline' onClick={handleVerifyInstallation} disabled={verifying} size='sm'>
              {verifying ? (
                <>
