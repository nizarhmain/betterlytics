...
import { CampaignMediumBreakdownItem } from "@/entities/campaign"; // Correct type for data
import {
  Table,
  TableHeader,
  TableBody,
  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <h3>Medium Engagement Metrics</h3>
        <p>Engagement details for each campaign medium</p>
