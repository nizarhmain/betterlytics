...
export default function CampaignPieChart({
  ...
  if (isLoading) {
    return (
      <div className='bg-card border-border flex min-h-[300px] items-center justify-center rounded-lg border p-6 shadow'>
  ...
  return (
    <div className='bg-card border-border rounded-lg border p-6 shadow'>
      <h2 className='text-foreground mb-1 text-lg font-bold'>{title}</h2>
      <p className='text-muted-foreground mb-4 text-sm'>{subtitle}</p>
      <div className='mt-4 flex h-72 flex-col items-center md:h-80'>
