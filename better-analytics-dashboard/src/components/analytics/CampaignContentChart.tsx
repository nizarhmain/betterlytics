...
export default function CampaignContentChart({ data, isLoading }: CampaignContentChartProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h2 className="text-lg font-bold text-gray-900 mb-1">Campaign Traffic by Content</h2>
      <p className="text-sm text-gray-500 mb-4">Distribution of campaign visitors by content</p>
