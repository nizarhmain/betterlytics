              ...
              */}
              <li>
                <Link
                  ...
                  rel='noopener noreferrer'
                >
                  <svg className='mr-2 h-4 w-4' viewBox='0 0 600 530' fill='currentColor'>
                    <path
              ...
              <li>
                <Link
                  ...
                  rel='noopener noreferrer'
                >
                  <svg className='mr-2 h-4 w-4' viewBox='0 0 127.14 96.36' fill='currentColor'>
